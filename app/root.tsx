...
import abi from "~/utils/app.json";
...
function Layout({ children }: React.PropsWithChildren<{}>) {
  ...
  const [countNo, setCountNo] = React.useState(0);
  const contractAddress = "0xceD545B7dAeDC35Fb2acC5C8AF45db7FBd3dC275";
  ...
  const checkIfWalletIsConnected = () => {
    ...
    if (!ethereum) {
      console.log("Check and make sure you have metamask!");
      return;
    } else {
